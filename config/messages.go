...
const (
	...
	SpeechErrorNotExist		= "Lo siento, no existe un bebé registrado con tu cuenta. Comienza pidiéndome añadir a tu bebé"
	SpeechErrorNoName		= "Lo siento, pero el nombre del bebé no lo he reconocido. Vuelve a intentarlo por favor."
	SpeechErrorNoPeso		= "Lo siento, pero no he podido reconocer el peso del bebé. Vuelve a intentarlo por favor."
	SpeechErrorNoToma		= "Lo siento, pero no he podido reconocer la toma del bebé. Vuelve a intentarlo por favor."
